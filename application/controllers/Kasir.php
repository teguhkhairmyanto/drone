...
class Kasir extends CI_Controller {
    ...
    if (!$this->session->userdata('idpengguna')) {
		...
		if ($this->session->userdata('jenispengguna')!=="2") {
			 redirect('/Welcome','refresh');
		}
	...
	public function nonaktifkan_pesanan($idpesanan)
	{
		$statuspesanan=array('statuspesanan'=>'0');
		$this->pesanan_model->Nonaktifkan($idpesanan, $statuspesanan, 'pesanan');

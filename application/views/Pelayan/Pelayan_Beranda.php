      ...
      <div class="row">
        ...
        <h3>Daftar Pesanan</h3>
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped  display" width="100%">
            ...
            <td><a href="<?php echo base_url();?>index.php/Pelayan/lihat_pesanan/<?php echo $daftarpesananaktifs->idpesanan; ?>"><button class="btn btn-primary" >Lihat Pesanan</button></td>
            <?php }} ?>
            </tbody>
        </table>
          </div>

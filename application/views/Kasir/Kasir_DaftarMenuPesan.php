      ...
      <div class="row">
        ...
        <h3>Daftar Menu</h3>
          ...
          <br>
            ...
            <td><a href="<?php echo base_url();?>index.php/Pelayan/tambah_isipesanan/<?php echo $idpesanan; ?>/<?php echo $daftarmenus->idmenu;?>"><button class="btn btn-primary">+</button></a></td>
            <?php } ?> 
            </tbody>
        </table>
            <a href="<?php echo base_url();?>index.php/Pelayan"><button class="btn btn-primary">Selesai</button></a>
            <br>
            <br>
          </div>
          <!-- /.row -->
